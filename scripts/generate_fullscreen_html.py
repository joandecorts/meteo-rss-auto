...
# 3. Guarda fitxers a la carpeta outputs/
...
def main():
    ...
    print("   4. Guarda a carpeta outputs/")
    print("=" * 60)
    ...
    for station_code, data in stations.items():
        ...
        if station_code == 'XJ':
            filename = "outputs/girona_full_screen.html"  # MODIFICAT
        elif station_code == 'UO':
            filename = "outputs/fornells_full_screen.html"  # MODIFICAT
        else:
    ...
    print("=" * 60)
    print("   git add outputs/girona_full_screen.html outputs/fornells_full_screen.html")  # MODIFICAT
