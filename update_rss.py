...
<channel>
    ...
    <link>https://github.com/joandecoris/meteocat-rss</link>
...
{chr(10).join(items)}
    ...
    # Guardar el fitxer RSS (amb el nom REAL meteo.rss)
    with open("meteo.rss", "w", encoding="utf-8") as f:
        f.write(rss_content)
    
    print("RSS feed generated successfully with multiple stations")

def main():
    # Llista d'estacions que volem monitoritzar
    stations = [
        {"code": "XJ", "name": "Girona"},
    ...
    if all_weather_data:
        ...
        print(f"Successfully fetched data for {len(all_weather_data)} stations")
        
        # Generar el RSS feed amb les dades recopilades
        generate_rss_feed()
    else:
        print("No data fetched for any station")
